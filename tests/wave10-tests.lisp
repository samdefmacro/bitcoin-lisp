...
2.0 responses are always 200 (Core httprpc.cpp JSONErrorReply)."
  ...
  (let ((ok (bitcoin-lisp.rpc::make-rpc-response 1 1))
        (nf (bitcoin-lisp.rpc::make-rpc-error-response -32601 "Method not found" 1))
        (misc (bitcoin-lisp.rpc::make-rpc-error-response -1 "x" 1)))
