  ...
  (let ((dir (gensym "DIR")))
    `(let* ((,dir (%wallet-temp-dir))
       ...
       (unwind-protect (progn ,@body)
         (ignore-errors
          (bl.rpc:close-wallet-manager (%node-manager ,node)))
...
(no best-block write) and drop it from the manager."
  (let* ((manager (%node-manager node))
         (wallet (gethash name (bl.rpc::wallet-manager-wallets manager))))
    (bl.store:leveldb-close (bl.rpc::wallet-db wallet))
    (remhash name (bl.rpc::wallet-manager-wallets manager))
    (setf (bl.rpc::wallet-manager-wallet-order manager)
          (remove name (bl.rpc::wallet-manager-wallet-order manager)
                  :test #'string=))))
...
(the DataStream encoding Core writes)."
  ...
  (let ((id (make-array 32 :element-type '(unsigned-byte 8) :initial-element 7)))
    (multiple-value-bind (type fields)
        (bl.rpc::wdb-parse-key (bl.rpc::wdb-key-descriptor id))
      (is (string= type "walletdescriptor"))
      (is (equalp id fields)))
    (multiple-value-bind (type fields)
        (bl.rpc::wdb-parse-key
         (bl.rpc::wdb-key-lockedutxo id 5))
...
byte for byte."
  ...
  (is (equalp #(3 97 98 99                    ; "abc"
              ...
              (bl.rpc::wdb-descriptor-value "abc" 42 1 0 10)))
  (multiple-value-bind (str time next start end)
      (bl.rpc::wdb-parse-descriptor-value
       (bl.rpc::wdb-descriptor-value "abc" 42 1 0 10))
    (is (string= str "abc"))
  ...
  (let ((h (make-array 32 :element-type '(unsigned-byte 8) :initial-element 9)))
    (let ((bytes (bl.rpc::wdb-block-locator-value (list h))))
      (is (equalp #(#x80 #x11 #x01 #x00 1) (subseq bytes 0 5)))
      (is (equalp (list h) (bl.rpc::wdb-parse-block-locator-value bytes))))
    (is (null (bl.rpc::wdb-parse-block-locator-value
               (bl.rpc::wdb-block-locator-value '()))))))
...
(test wallet-privkey-der-roundtrip
  ...
  (let ((priv (make-array 32 :element-type '(unsigned-byte 8)
    ...
    (let ((der-c (bl.rpc::privkey-to-der priv t))
          (der-u (bl.rpc::privkey-to-der priv nil)))
      (is (= 214 (length der-c)))          ; CKey::COMPRESSED_SIZE
      (is (= 279 (length der-u)))          ; CKey::SIZE
      (is (equalp priv (bl.rpc::der-to-privkey der-c)))
      (is (equalp priv (bl.rpc::der-to-privkey der-u)))
      (is (null (bl.rpc::der-to-privkey (subseq der-c 0 40)))))))
...
(test wallet-record-schema-roundtrip
  ...
  (let* ((dir (%wallet-temp-dir))
    ...
    (unwind-protect
         (progn
           (let ((db (bl.rpc::wallet-db-open path :create t)))
             (flet ((put (key value)
                      (push (cons key value) written)
                      (bl.store:leveldb-put db key value)))
               (put (bl.rpc::wdb-key-descriptor id)
                    (bl.rpc::wdb-descriptor-value "wpkh(x)#00000000" 7 1 0 5))
               (put (bl.rpc::wdb-key-descriptor-key
                     bl.rpc::+wdb-key-walletdescriptorkey+ id pubkey)
                    (bl.rpc::wdb-descriptor-key-value
                     pubkey (bl.rpc::privkey-to-der priv t)))
               (put (bl.rpc::wdb-key-descriptor-key
                     bl.rpc::+wdb-key-walletdescriptorckey+ id pubkey)
                    (bl.rpc::wdb-vector-value #(1 2 3 4)))
               (put (bl.rpc::wdb-key-descriptor-parent-cache
                     bl.rpc::+wdb-key-walletdescriptorcache+ id 0)
                    (bl.rpc::wdb-xpub-value xpub))
               (put (bl.rpc::wdb-key-descriptor-derived-cache id 0 11)
                    (bl.rpc::wdb-xpub-value xpub))
               (put (bl.rpc::wdb-key-descriptor-parent-cache
                     bl.rpc::+wdb-key-walletdescriptorlhcache+ id 0)
                    (bl.rpc::wdb-xpub-value xpub))
               (put (bl.rpc::wdb-key-active-spk nil 2) id)
               (put (bl.rpc::wdb-key-active-spk t 3) id)
               (put (bl.rpc::wdb-key-simple
                     bl.rpc::+wdb-key-bestblock+)
                    (bl.rpc::wdb-block-locator-value '()))
               (put (bl.rpc::wdb-key-simple
                     bl.rpc::+wdb-key-bestblock-nomerkle+)
                    (bl.rpc::wdb-block-locator-value (list txid)))
               (put (bl.rpc::wdb-key-address-string
                     bl.rpc::+wdb-key-name+ "addr1")
                    (bl.rpc::wdb-string-value "label1"))
               (put (bl.rpc::wdb-key-address-string
                     bl.rpc::+wdb-key-purpose+ "addr1")
                    (bl.rpc::wdb-string-value "receive"))
               (put (bl.rpc::wdb-key-simple
                     bl.rpc::+wdb-key-flags+)
                    (bl.rpc::wdb-uint64-value
                     bl.rpc::+wallet-flag-descriptors+))
               (put (bl.rpc::wdb-key-mkey 1)
                    (bl.rpc::wdb-mkey-value #(9 9) #(8 8 8) 0 25000 #()))
               (put (bl.rpc::wdb-key-simple
                     bl.rpc::+wdb-key-orderposnext+)
                    (bl.rpc::wdb-int64-value 12345))
               (put (bl.rpc::wdb-key-lockedutxo txid 1)
                    bl.rpc::+wdb-lockedutxo-value+)
               (put (bl.rpc::wdb-key-simple
                     bl.rpc::+wdb-key-minversion+)
                    (bl.rpc::wdb-int32-value 169900))
               (put (bl.rpc::wdb-key-simple
                     bl.rpc::+wdb-key-version+)
                    (bl.rpc::wdb-int32-value
                     bl.rpc::+wallet-client-version+))
               (put (bl.rpc::wdb-key-tx txid)
                    (bl.rpc::wdb-vector-value #())))
             (bl.store:leveldb-close db))
           ;; Reopen and compare every record byte-for-byte.
           (let* ((db (bl.rpc::wallet-db-open path))
                  (records (bl.rpc::wallet-db-records db)))
             ...
             ;; mkey parses back
             (let ((mkey (find (bl.rpc::wdb-key-mkey 1) records
                               :key #'car :test #'equalp)))
               (multiple-value-bind (ck salt method iters other)
                   (bl.rpc::wdb-parse-mkey-value (cdr mkey))
                 (is (equalp #(9 9) ck))
             ...
             (let ((rec (find (bl.rpc::wdb-key-descriptor-derived-cache id 0 11)
                              records :key #'car :test #'equalp)))
               (let ((decoded (bl.rpc::wdb-parse-xpub-value (cdr rec) :testnet4)))
...
cache)."
  (with-wallet-test-node (node :network :testnet4 :keypool 3)
    (let* ((manager (%node-manager node))
           ...
           (wallet (bl.rpc::create-wallet manager "fixed" :blank t)))
      (bl.rpc::with-wallet-lock (wallet)
        (bl.rpc::wallet-setup-descriptor-spkms wallet master))
      (is (= 8 (hash-table-count (bl.rpc::wallet-spkms wallet))))
      (is (= 4 (hash-table-count (bl.rpc::wallet-external-spkms wallet))))
      (is (= 4 (hash-table-count (bl.rpc::wallet-internal-spkms wallet))))
      ...
      (dolist (spec '((:bech32 84 0) (:bech32m 86 0) (:legacy 44 0)
        ...
        (destructuring-bind (type purpose internal) spec
          (let* ((spkm (gethash type (if (= internal 1)
                                         (bl.rpc::wallet-internal-spkms wallet)
                                         (bl.rpc::wallet-external-spkms wallet))))
                 ...
                 (next (bl.rpc::desc-spkm-next-index spkm))
                 (expected (bl.rpc::%script->address
                            (first (bl.rpc::out-desc-expand desc next))
                            :testnet4))
                 (issued (bl.rpc::with-wallet-lock (wallet)
                           (bl.rpc::spkm-get-new-destination
                            wallet spkm type))))
...
hands out Core's script at index 0."
  (with-wallet-test-node (node :network :mainnet :keypool 3)
    (let* ((manager (%node-manager node))
           (wallet (bl.rpc::create-wallet manager "corevec" :blank t))
      ...
      (let* ((bl.rpc::*rpc-wallet-name* "corevec")
      ...
      (let* ((wallet (gethash "corevec"
                              (bl.rpc::wallet-manager-wallets manager)))
             (spkm (gethash :bech32
                            (bl.rpc::wallet-external-spkms wallet))))
        (is (not (null spkm)))
        (loop for hex in core-scripts
              for i from 0
              do (is (eql i (bl.rpc::spkm-is-mine
                             spkm (bl.crypto:hex-to-bytes hex)))))
        ;; getnewaddress bech32 = Core's script at index 0
        (let ((bl.rpc::*rpc-wallet-name* "corevec"))
          (let ((address (bl.rpc::rpc-getnewaddress
                          node '("" "bech32"))))
...
wallet_taproot.py independent-implementation vectors, tweaked per BIP341."
  (with-wallet-test-node (node :network :testnet4 :keypool 4)
    (let* ((manager (%node-manager node))
      ...
      (bl.rpc::create-wallet manager "trvec" :blank t)
      (let* ((bl.rpc::*rpc-wallet-name* "trvec")
             (results (bl.rpc::rpc-importdescriptors
                       node (list (list (%ht "desc" desc-str
                                             "timestamp" 1
                                             "active" t
        ...
        (dolist (pub-hex core-pubs)
          (let* ((internal (bl.crypto:hex-to-bytes pub-hex))
                 ...
                 (expected (bl.crypto:encode-p2tr-address
                            tweaked :testnet4))
                 (address (bl.rpc::rpc-getnewaddress
                           node '("" "bech32m"))))
  ...
  (with-wallet-test-node (node :network :testnet4 :keypool 5)
    (let ((issued '()))
      (let ((bl.rpc::*rpc-wallet-name* nil))
        (bl.rpc::rpc-createwallet node '("crashy"))
        ;; 7 bech32 (crosses the initial keypool window and forces TopUp),
        ;; plus a few of the other types and a change address.
        (dotimes (i 7)
          (push (bl.rpc::rpc-getnewaddress node '("" "bech32")) issued))
        (dolist (type '("legacy" "p2sh-segwit" "bech32m"))
          (push (bl.rpc::rpc-getnewaddress node (list "" type)) issued)
          (push (bl.rpc::rpc-getrawchangeaddress node (list type)) issued))
        (push (bl.rpc::rpc-getrawchangeaddress node '("bech32")) issued))
      (is (= 14 (length issued)))
      ...
      (let ((bl.rpc::*rpc-wallet-name* nil)
            (fresh '()))
        (bl.rpc::rpc-loadwallet node '("crashy"))
        (dotimes (i 3)
          (push (bl.rpc::rpc-getnewaddress node '("" "bech32")) fresh))
        (dolist (type '("legacy" "p2sh-segwit" "bech32m"))
          (push (bl.rpc::rpc-getnewaddress node (list "" type)) fresh)
          (push (bl.rpc::rpc-getrawchangeaddress node (list type)) fresh))
        (push (bl.rpc::rpc-getrawchangeaddress node '("bech32")) fresh)
...
close/reopen (record schema round-trip at the wallet level)."
  (with-wallet-test-node (node :network :testnet4 :keypool 5)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("persist")))
    (let* ((manager (%node-manager node))
           (wallet (gethash "persist" (bl.rpc::wallet-manager-wallets
                                       manager)))
           (addr1 (let ((bl.rpc::*rpc-wallet-name* nil))
                    (bl.rpc::rpc-getnewaddress node '("" "bech32"))))
           ...
           (spkm-state (lambda (w)
                         (sort (loop for spkm being the hash-values
                                       of (bl.rpc::wallet-spkms w)
                                     collect (list (bl.rpc::desc-spkm-desc-string spkm)
                                                   (bl.rpc::desc-spkm-next-index spkm)
                                                   (bl.rpc::desc-spkm-range-end spkm)))
                               #'string< :key #'first)))
           (descs-before (funcall spkm-state wallet)))
      (let ((bl.rpc::*rpc-wallet-name* nil))
        (bl.rpc::rpc-unloadwallet node '("persist"))
        (bl.rpc::rpc-loadwallet node '("persist")))
      (let* ((wallet2 (gethash "persist" (bl.rpc::wallet-manager-wallets
                                          manager)))
        ...
        (let* ((script (%address-script addr1 :testnet4))
               (spkm (gethash :bech32 (bl.rpc::wallet-external-spkms
                                       wallet2)))
               (index (bl.rpc::spkm-is-mine spkm script)))
          (is (eql 0 index))
          (is (< index (bl.rpc::desc-spkm-next-index spkm)))
          (is (bl.rpc::wallet-is-mine wallet2 script)))))))
...
reloads to Core's exact scripts (descriptor_tests.cpp sh(wpkh(...)) vector)."
  (with-wallet-test-node (node :network :mainnet :keypool 3)
    (let* ((manager (%node-manager node))
      ...
      (bl.rpc::create-wallet manager "hardened" :blank t)
      (let ((bl.rpc::*rpc-wallet-name* "hardened"))
      ...
      (let ((bl.rpc::*rpc-wallet-name* nil))
        (bl.rpc::rpc-unloadwallet node '("hardened"))
        (bl.rpc::rpc-loadwallet node '("hardened")))
      (let* ((wallet (gethash "hardened" (bl.rpc::wallet-manager-wallets
                                          manager)))
...
behave like Core, including the exact error codes."
  (with-wallet-test-node (node)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (is (string= "w1" (%aval "name" (bl.rpc::rpc-createwallet
                                       node '("w1")))))
      (is (equal '("w1") (bl.rpc::rpc-listwallets node nil)))
      (bl.rpc::rpc-createwallet node '("w2"))
      (is (equal '("w1" "w2") (bl.rpc::rpc-listwallets node nil)))
      ;; duplicate create -> -36; reload of loaded -> -35; unknown -> -18
      (is (= bl.rpc::+rpc-wallet-already-exists+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-createwallet node '("w1"))))))
      (is (= bl.rpc::+rpc-wallet-already-loaded+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-loadwallet node '("w1"))))))
      (is (= bl.rpc::+rpc-wallet-not-found+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-loadwallet node '("nope"))))))
      ;; unload w1, reload it
      (bl.rpc::rpc-unloadwallet node '("w1"))
      (is (equal '("w2") (bl.rpc::rpc-listwallets node nil)))
      (is (= bl.rpc::+rpc-wallet-not-found+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-unloadwallet node '("w1"))))))
      (bl.rpc::rpc-loadwallet node '("w1"))
      (is (equal '("w2" "w1") (bl.rpc::rpc-listwallets node nil)))
      ;; unloadwallet endpoint/param mismatch -> -8; neither -> -8
      (let ((bl.rpc::*rpc-wallet-name* "w1"))
        (is (= bl.rpc::+rpc-invalid-parameter+
               (%rpc-error-code
                (lambda () (bl.rpc::rpc-unloadwallet node '("w2")))))))
      (is (= bl.rpc::+rpc-invalid-parameter+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-unloadwallet node '())))))
      ;; listwalletdir sees both, loaded or not
      (let ((dir-names (mapcar (lambda (w) (%aval "name" w))
                               (%aval "wallets"
                                      (bl.rpc::rpc-listwalletdir node nil)))))
      ...
      (is (bl.rpc::wallet-has-encryption-keys-p
           (gethash "enc0" (bl.rpc::wallet-manager-wallets
                            (%node-manager node)))))
      (is (= bl.rpc::+rpc-wallet-error+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-createwallet
      ...
      (is (= bl.rpc::+rpc-invalid-parameter+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-createwallet node '("")))))))))
...
getwalletinfo reports Core's fields."
  (with-wallet-test-node (node)
    (let ((bl.rpc::*rpc-wallet-name* "wo"))
      ...
      (let ((bl.rpc::*rpc-wallet-name* nil))
        (bl.rpc::rpc-createwallet node '("wo" t t nil t)))
      (let ((info (bl.rpc::rpc-getwalletinfo node nil)))
      ...
      (is (= bl.rpc::+rpc-wallet-error+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-getnewaddress node nil))))))
    ;; full wallet: keypool counts are per-side
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("full")))
    (let* ((bl.rpc::*rpc-wallet-name* "full")
           (info (bl.rpc::rpc-getwalletinfo node nil)))
...
wallet (-18), no wallet loaded (-18), and ambiguous wallet (-19)."
  ;; URI parsing
  (is (string= "foo" (bl.rpc::wallet-name-from-uri "/wallet/foo")))
  (is (string= "a b" (bl.rpc::wallet-name-from-uri "/wallet/a b")))
  (is (null (bl.rpc::wallet-name-from-uri "/")))
  (is (null (bl.rpc::wallet-name-from-uri "/wallet/")))
  (is (null (bl.rpc::wallet-name-from-uri "/walletx/foo")))
  (with-wallet-test-node (node)
    ;; no wallet loaded -> -18
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (is (= bl.rpc::+rpc-wallet-not-found+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-getwalletinfo node nil)))))
      (bl.rpc::rpc-createwallet node '("r1"))
      ;; single wallet: base endpoint resolves to it
      (is (string= "r1" (%aval "walletname"
                               (bl.rpc::rpc-getwalletinfo node nil))))
      (bl.rpc::rpc-createwallet node '("r2"))
      ;; two wallets: base endpoint is ambiguous -> -19
      (is (= bl.rpc::+rpc-wallet-not-specified+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-getwalletinfo node nil))))))
    ;; endpoint routing picks the named wallet
    (let ((bl.rpc::*rpc-wallet-name* "r2"))
      (is (string= "r2" (%aval "walletname"
                               (bl.rpc::rpc-getwalletinfo node nil)))))
    ;; unknown wallet endpoint -> -18 with Core's message
    (let ((bl.rpc::*rpc-wallet-name* "missing"))
      (handler-case (progn (bl.rpc::rpc-getwalletinfo node nil)
    ...
    (let ((bl.rpc::*rpc-wallet-name* "r2"))
      (bl.rpc::rpc-unloadwallet node '()))
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (is (equal '("r1") (bl.rpc::rpc-listwallets node nil))))))
...
no-wallet Core build."
  (let ((node (bl::make-node :network :testnet4)))
    ...
    (is (= bl.rpc::+rpc-method-not-found+
           (%rpc-error-code
            (lambda () (bl.rpc::rpc-createwallet node '("x"))))))
    (is (= bl.rpc::+rpc-method-not-found+
           (%rpc-error-code
            (lambda () (bl.rpc::rpc-listwallets node nil)))))))
    ...
    (let ((bl.rpc::*rpc-wallet-name* nil))
      ...
      (let ((wallet (gethash "types"
        ...
        (loop for (type . prefix-test)
              ...
              do (let ((recv (bl.rpc::rpc-getnewaddress
                              node (list "" type)))
                       (change (bl.rpc::rpc-getrawchangeaddress
                                node (list type))))
        ...
        (is (= bl.rpc::+rpc-invalid-address-or-key+
               (%rpc-error-code
                (lambda () (bl.rpc::rpc-getnewaddress
                            node '("" "p2wpkh"))))))
...
private=true."
  (with-wallet-test-node (node :keypool 3)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("ld")))
    (let* ((bl.rpc::*rpc-wallet-name* "ld")
           (result (bl.rpc::rpc-listdescriptors node nil))
    ...
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("ldwo" t)))
    (let ((bl.rpc::*rpc-wallet-name* "ldwo"))
      (is (= bl.rpc::+rpc-wallet-error+
             (%rpc-error-code
...
throws out of the whole call."
  (with-wallet-test-node (node :keypool 3)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("imp"))     ; privkeys enabled
      (bl.rpc::rpc-createwallet node '("impwo" t t))) ; watch-only blank
    ...
    (let ((bl.rpc::*rpc-wallet-name* "impwo"))
      (let* ((xpub "tpubD6NzVbkrYhZ4XqNGAWGWSzmxGWFwVjVTjZxh2fioKbVYi7Jx8fdbprVWsdW7mHwqjchBVas8TLZG4Xwuz4RKU4iaCqiCvoSkFCzQptqk5Y1")
        ...
        (let ((address (bl.rpc::rpc-getnewaddress node '("" "bech32"))))
          (is (string= "tb1q" (subseq address 0 4))))
        ;; and listdescriptors shows it active
        (let ((descs (%aval "descriptors"
                            (bl.rpc::rpc-listdescriptors node nil))))
          (is (= 1 (length descs)))
...
wallet does not own -4 (Core wallet/rpc/signmessage.cpp error codes)."
  (with-wallet-test-node (node :keypool 4)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("signer")))
    (let* ((bl.rpc::*rpc-wallet-name* "signer")
           (address (bl.rpc::rpc-getnewaddress node '("" "legacy")))
           (message "hello from bitcoin-lisp")
           (sig (bl.rpc::rpc-signmessage node (list address message))))
      (is (stringp sig))
      ...
      (let ((bech32 (bl.rpc::rpc-getnewaddress node '("" "bech32"))))
        (is (= bl.rpc::+rpc-type-error+
               (%rpc-error-code
...
silently resuming address reuse."
  (with-wallet-test-node (node :keypool 4)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("flags")))
    (let* ((bl.rpc::*rpc-wallet-name* "flags")
           (manager (%node-manager node))
           (wallet (gethash "flags" (bl.rpc::wallet-manager-wallets manager))))
      ;; Setting it on: Core's exact result shape, including the caveat.
      (let ((r (bl.rpc::rpc-setwalletflag node '("avoid_reuse"))))
      ...
      (is-true (bl.rpc::wallet-flag-set-p
      ...
      (is (= bl.rpc::+rpc-invalid-parameter+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-setwalletflag node '("avoid_reuse"))))))
      ;; Off again, and no caveat this time (Core reports it only when SETTING).
      (let ((r (bl.rpc::rpc-setwalletflag
      ...
      (is-false (bl.rpc::wallet-flag-set-p
                 wallet bl.rpc::+wallet-flag-avoid-reuse+))
      ...
      (dolist (immutable '("blank" "descriptor_wallet" "disable_private_keys"
        ...
        (is (= bl.rpc::+rpc-invalid-parameter+
               (%rpc-error-code
                (lambda () (bl.rpc::rpc-setwalletflag node (list immutable)))))
            "~A was not refused as immutable" immutable))
      (is (= bl.rpc::+rpc-invalid-parameter+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-setwalletflag node '("no_such_flag"))))))
      ;; And it PERSISTED: the flag word is on disk, not just in the struct.
      (bl.rpc::rpc-setwalletflag node '("avoid_reuse"))
      (is-true (bl.rpc::wallet-flag-set-p
                wallet bl.rpc::+wallet-flag-avoid-reuse+))
      (let ((stored (bl.store:leveldb-get
                     (bl.rpc::wallet-db wallet)
                     (bl.rpc::wdb-key-simple bl.rpc::+wdb-key-flags+))))
...
derivation paths cannot drift between the two."
  (with-wallet-test-node (node :keypool 4)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("cwd")))
    (let* ((bl.rpc::*rpc-wallet-name* "cwd")
           (manager (%node-manager node))
           (wallet (gethash "cwd" (bl.rpc::wallet-manager-wallets manager))))
      ;; Everything already exists on a freshly created wallet.
      (is (= bl.rpc::+rpc-wallet-error+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-createwalletdescriptor node '("bech32m"))))))
      ;; An unknown address type is refused by name.
      (is (= bl.rpc::+rpc-invalid-address-or-key+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-createwalletdescriptor node '("nosuchtype"))))))
      ;; Now remove one side and re-create it: the real path.
      (let* ((removed (gethash :bech32m (bl.rpc::wallet-internal-spkms wallet)))
             (id (and removed (bl.rpc::desc-spkm-id removed))))
        (is-true removed "fixture: the wallet should have an internal bech32m spkm")
        (remhash :bech32m (bl.rpc::wallet-internal-spkms wallet))
        (remhash id (bl.rpc::wallet-spkms wallet))
        (let* ((opts (let ((h (make-hash-table :test 'equal)))
                       (setf (gethash "internal" h) t) h))
               (r (bl.rpc::rpc-createwalletdescriptor
          ...
          (is (search "/1/*" (first descs))
              ...
              (first descs))
          (is-true (gethash :bech32m (bl.rpc::wallet-internal-spkms wallet))
      ...
      (let ((opts (let ((h (make-hash-table :test 'equal)))
        ...
        (is (= bl.rpc::+rpc-invalid-address-or-key+
               (%rpc-error-code
                (lambda () (bl.rpc::rpc-createwalletdescriptor
...
is what tells an operator which key their wallet actually depends on."
  (with-wallet-test-node (node :keypool 4)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("hd")))
    (let ((bl.rpc::*rpc-wallet-name* "hd"))
      (let ((rows (bl.rpc::rpc-gethdkeys node nil)))
        ...
        (let* ((opts (let ((h (make-hash-table :test 'equal)))
               ...
               (priv (first (bl.rpc::rpc-gethdkeys node (list opts)))))
        ...
        (let* ((opts (let ((h (make-hash-table :test 'equal)))
               ...
               (active (bl.rpc::rpc-gethdkeys node (list opts))))
          (is (= 1 (length active))))))))
...
hook wired inside the branch."
  (let ((dir (merge-pathnames (format nil "bl-wn-~D/" (get-internal-real-time))
    ...
    (unwind-protect
         (progn
           ...
           (with-wallet-test-node (node :keypool 4)
             (let ((bl.rpc::*rpc-wallet-name* nil))
               (bl.rpc::rpc-createwallet node '("notif")))
             (let* ((manager (%node-manager node))
                    (wallet (gethash "notif"
                                     (bl.rpc::wallet-manager-wallets
                                      manager)))
                    (bl.rpc::*rpc-wallet-name* "notif")
                    (bl.rpc::*wallet-notify-command*
               ...
               (setf (bl.rpc::wallet-last-block-height wallet) 100)
               (let* ((addr (bl.rpc::rpc-getnewaddress
                             node '("" "legacy")))
  ...
  (is-false (bl.rpc::%valid-wallet-name-p "a;rm -rf /"))
...
-> -4."
  (with-wallet-test-node (node :keypool 4)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("recv")))
    (let* ((manager (%node-manager node))
           (wallet (gethash "recv"
                            (bl.rpc::wallet-manager-wallets manager)))
           (bl.rpc::*rpc-wallet-name* "recv"))
      (setf (bl.rpc::wallet-last-block-height wallet) 100)
      (let* ((addr (bl.rpc::rpc-getnewaddress node '("" "legacy")))
             (script (%address-script addr :testnet4)))
        (bl.rpc::rpc-setlabel node (list addr "L1"))
        ...
        (is (%wt= 0.008d0 (bl.rpc::rpc-getreceivedbyaddress
                           node (list addr))))
        (is (%wt= 0.008d0 (bl.rpc::rpc-getreceivedbylabel
                           node (list "L1"))))
        ;; minconf 200 excludes the depth-1 receives.
        (is (%wt= 0.0d0 (bl.rpc::rpc-getreceivedbyaddress
                         node (list addr 200))))
        ;; listreceivedbyaddress: one row for addr with both txids.
        (let* ((rows (bl.rpc::rpc-listreceivedbyaddress node nil))
        ...
        (let* ((rows (bl.rpc::rpc-listreceivedbylabel node nil))
        ...
        (let ((foreign (bl.crypto:encode-p2pkh-address
          ...
          (is (= bl.rpc::+rpc-wallet-error+
                 (%rpc-error-code
                  (lambda () (bl.rpc::rpc-getreceivedbyaddress
                              node (list foreign)))))))
        (is (= bl.rpc::+rpc-invalid-address-or-key+
               (%rpc-error-code
                (lambda () (bl.rpc::rpc-getreceivedbyaddress
        ...
        (is (= bl.rpc::+rpc-wallet-error+
               (%rpc-error-code
                (lambda () (bl.rpc::rpc-getreceivedbylabel
...
(test wallet-keypoolrefill-grows-active-spkms
  ...
  (with-wallet-test-node (node :keypool 5)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("kp")))
    (let* ((manager (%node-manager node))
           (wallet (gethash "kp"
                            (bl.rpc::wallet-manager-wallets manager)))
           (bl.rpc::*rpc-wallet-name* "kp")
           (spkm (gethash :bech32
                          (bl.rpc::wallet-external-spkms wallet))))
      (is (= 5 (bl.rpc::spkm-keypool-count spkm)))
      (is (null (bl.rpc::rpc-keypoolrefill node '(20))))
      (is (>= (bl.rpc::spkm-keypool-count spkm) 20))
      ;; Every active SPKM grew.
      (dolist (s (bl.rpc::%wallet-active-spkms wallet))
        (is (>= (bl.rpc::spkm-keypool-count s) 20)))
      (is (= bl.rpc::+rpc-invalid-parameter+
             (%rpc-error-code
              (lambda () (bl.rpc::rpc-keypoolrefill node '(-1)))))))))
...
rejects a double-spend across the array."
  (with-wallet-test-node (node :keypool 4)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("sim")))
    (let* ((manager (%node-manager node))
           (wallet (gethash "sim"
                            (bl.rpc::wallet-manager-wallets manager)))
           (bl.rpc::*rpc-wallet-name* "sim"))
      (setf (bl.rpc::wallet-last-block-height wallet) 100)
      (let* ((addr (bl.rpc::rpc-getnewaddress node '("" "bech32")))
             (script (%address-script addr :testnet4))
        ...
        (let ((result (bl.rpc::rpc-simulaterawtransaction
        ...
        (let ((funded (%wt-add-confirmed-tx
          ...
          (is (= bl.rpc::+rpc-invalid-parameter+
                 (%rpc-error-code
                  (lambda ()
                    (bl.rpc::rpc-simulaterawtransaction
...
keeps an unrelated lone address in its own group."
  (with-wallet-test-node (node :keypool 5)
    (let ((bl.rpc::*rpc-wallet-name* nil))
      (bl.rpc::rpc-createwallet node '("grp")))
    (let* ((manager (%node-manager node))
           (wallet (gethash "grp"
                            (bl.rpc::wallet-manager-wallets manager)))
           (bl.rpc::*rpc-wallet-name* "grp"))
      (setf (bl.rpc::wallet-last-block-height wallet) 100)
      (let* ((addr1 (bl.rpc::rpc-getnewaddress node '("" "legacy")))
             (addr2 (bl.rpc::rpc-getnewaddress node '("" "legacy")))
             (addr3 (bl.rpc::rpc-getnewaddress node '("" "legacy")))
        ...
        (%wt-add-confirmed-tx wallet
                              ...
                              (list (cons s3 900000)))
        (let* ((groups (bl.rpc::rpc-listaddressgroupings node nil))
...
mature them. Returns the wallet."
  ...
  (let* ((wallet (gethash "w" (bl.rpc::wallet-manager-wallets
                               (bl::node-wallet-manager node))))
...
that our own script verifier accepts and the mempool relays."
  (%with-pp-node (node "pp-wcfp")
    (let ((wallet (%pp-fund-wallet node)))
      (let* ((bl.rpc::*wallet-rng* (bl.rpc::make-wrng 42))
             (dest (%pp-optrue-address))
             (created (bl.rpc::rpc-walletcreatefundedpsbt
        ...
        (let* ((processed (bl.rpc::rpc-walletprocesspsbt node (list b64)))
...
second call with sign=true (default) completes it."
  (%with-pp-node (node "pp-signflag")
    (%pp-fund-wallet node)
    (let* ((bl.rpc::*wallet-rng* (bl.rpc::make-wrng 99))
           (dest (%pp-optrue-address))
           (b64 (%aval "psbt" (bl.rpc::rpc-walletcreatefundedpsbt
                               node (list '() (list (%ht dest 1)) 0 (%ht "fee_rate" 5)))))
           ;; sign=false, finalize=false: no partial sigs, incomplete.
           (unsigned (bl.rpc::rpc-walletprocesspsbt
      ...
      (let ((signed (bl.rpc::rpc-walletprocesspsbt
...
(psbt.cpp:514-549): with a segwit-v0 input present nothing may be dropped."
  (%with-pp-node (node "pp-nwutxo")
    (%pp-fund-wallet node)
    (let* ((bl.rpc::*wallet-rng* (bl.rpc::make-wrng 17))
           (dest (%pp-optrue-address))
           (b64 (%aval "psbt" (bl.rpc::rpc-walletcreatefundedpsbt
                               node (list '() (list (%ht dest 1)) 0 (%ht "fee_rate" 5)))))
      ...
      (let* ((stripped (bl.ser:encode-psbt psbt))
             (filled (bl.rpc::rpc-walletprocesspsbt
        ...
        (loop for m across (bl.ser:psbt-inputs out)
              ...
              do (let ((real (bl.ser:tx-out-value
                              (bl.rpc::%psbt-input-prevout m in))))
                   (is (plusp real))
...
refuses to bump an already-bumped tx."
  (%with-pp-node (node "pp-bump")
    (let ((wallet (%pp-fund-wallet node :blocks 2)))
      (let* ((bl.rpc::*wallet-rng* (bl.rpc::make-wrng 7))
             (dest (%pp-optrue-address))
        ...
        (let ((orig-inputs (%pp-input-outpoints orig-tx))
          ...
          (let* ((new-txid-hex (%aval "txid" result))
            ...
            (let ((owtx (bl.rpc::wallet-get-wallet-tx wallet txid)))
              (is (string= new-txid-hex
                           (cdr (assoc "replaced_by_txid"
                                       (bl.rpc::wallet-tx-map-value owtx)
                                       :test #'string=)))))
            ;; Cannot bump the same (already-bumped) tx again.
            (signals bl.rpc::rpc-error
              (bl.rpc::rpc-bumpfee node (list txid-hex (%ht "fee_rate" 40))))))))))
...
(defun %wallet-settings-dir (node)
  (bl.rpc::wallet-manager-data-directory (%node-manager node)))

(defun %wallet-settings-path (node)
  (bl.rpc::settings-json-path (%wallet-settings-dir node)))
...
(defun %startup-names (node)
  (bl.rpc::wallet-startup-names (%wallet-settings-dir node)))
...
(defun %loaded-wallet-names (node)
  (coerce (bl.rpc::rpc-listwallets node nil) 'list))
...
removes it. Only an explicit value writes anything."
  (with-wallet-test-node (node)
    ...
    (bl.rpc::rpc-createwallet node '("plain"))
    ...
    (bl.rpc::rpc-createwallet node (list "auto" nil nil nil nil nil t))
    (is (equal '("auto") (%startup-names node)))
    ;; Explicit null on an already-recorded wallet leaves it recorded.
    (bl.rpc::rpc-unloadwallet node '("auto"))
    (is (equal '("auto") (%startup-names node)))
    (bl.rpc::rpc-loadwallet node '("auto"))
    (is (equal '("auto") (%startup-names node)))
    ;; Explicit false removes it.
    (bl.rpc::rpc-unloadwallet
     node (list "auto" bl.rpc::+json-false+))
    (is (null (%startup-names node)))
    ;; loadwallet with true records a wallet created without it.
    (bl.rpc::rpc-unloadwallet node '("plain"))
    (bl.rpc::rpc-loadwallet node '("plain" t))
...
order is preserved."
  (with-wallet-test-node (node)
    (let ((dir (%wallet-settings-dir node)))
      (is (bl.rpc::update-wallet-setting dir "a" :true))
      (is (bl.rpc::update-wallet-setting dir "a" :true))
      (is (equal '("a") (bl.rpc::wallet-startup-names dir))
          "adding twice must not duplicate the entry")
      (bl.rpc::update-wallet-setting dir "b" :true)
      (bl.rpc::update-wallet-setting dir "c" :true)
      (is (equal '("a" "b" "c") (bl.rpc::wallet-startup-names dir)))
      (is (bl.rpc::update-wallet-setting dir "nosuch" :false)
          "removing an absent name is a successful no-op")
      (is (equal '("a" "b" "c") (bl.rpc::wallet-startup-names dir)))
      (bl.rpc::update-wallet-setting dir "b" :false)
      (is (equal '("a" "c") (bl.rpc::wallet-startup-names dir))
          "removal from the middle keeps the rest in order")
      ;; NIL action never touches the file.
      (is (bl.rpc::update-wallet-setting dir "zzz" nil))
      (is (equal '("a" "c") (bl.rpc::wallet-startup-names dir))))))
...
as a JSON array, not an object."
  (with-wallet-test-node (node)
    ...
    (is (bl.rpc::update-wallet-setting (%wallet-settings-dir node) "w" :true))
...
operator can still repair by hand."
  (with-wallet-test-node (node)
    (let ((garbage "{ this is not json"))
      ...
      (is (null (%startup-names node)))
      (is (null (bl.rpc::update-wallet-setting
      ...
      (is (bl.rpc::update-wallet-setting
...
be persisted (wallet.cpp:131-133)."
  (with-wallet-test-node (node)
    ...
    (let* ((result (bl.rpc::rpc-createwallet
...
load_on_startup must come back by itself; one that was not recorded must not."
  (with-wallet-test-node (node)
    (bl.rpc::rpc-createwallet node (list "keeper" nil nil nil nil nil t))
    (bl.rpc::rpc-createwallet node '("transient"))
    ...
    (bl.rpc:load-wallets-on-startup node)
...
the broken entry is listed FIRST here, so this fails if the loop aborts."
  (with-wallet-test-node (node)
    (bl.rpc::rpc-createwallet node '("good"))
    (let ((dir (%wallet-settings-dir node)))
      (bl.rpc::update-wallet-setting dir "ghost" :true)
      (bl.rpc::update-wallet-setting dir "good" :true)
      (is (equal '("ghost" "good") (bl.rpc::wallet-startup-names dir))))
    (%restart-wallet-manager node)
    (bl.rpc:load-wallets-on-startup node)
...
path is unavailable by construction and only a script path can spend."
  (with-wallet-test-node (node :network :mainnet :keypool 2)
    (let* ((manager (%node-manager node))
      ...
      (bl.rpc::create-wallet manager "trtree" :blank t)
      (let ((bl.rpc::*rpc-wallet-name* "trtree"))
        (let ((results (bl.rpc::rpc-importdescriptors
      ...
      (let* ((wallet (gethash "trtree" (bl.rpc::wallet-manager-wallets manager)))
        ...
        (let* ((witness (bl.ser:transaction-witness tx))
          ...
          (is (= 3 (length stack))
              ...
              (length stack)))
        (is-true (nth-value 0 (bl.rpc::%verify-tx-scripts tx coins))
