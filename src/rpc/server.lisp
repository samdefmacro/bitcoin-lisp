...
(defun register-all-methods ()
  ...
  (register-rpc-method "addpeeraddress" #'rpc-addpeeraddress)
  (register-rpc-method "sendmsgtopeer" #'rpc-sendmsgtopeer)
  (register-rpc-method "echojson" #'rpc-echojson)
  (register-rpc-method "gethdkeys" #'rpc-gethdkeys)
  (register-rpc-method "setwalletflag" #'rpc-setwalletflag)
  (register-rpc-method "createwalletdescriptor" #'rpc-createwalletdescriptor)
  (register-rpc-method "estimaterawfee" #'rpc-estimaterawfee)
