...
Date: 2026-07-15. Status (2026-08-22): **P0-P6 DONE** (P0 PR 283, P2 PR 288, P3 PR 290, P4 PR 293 per §5; P1, P5 and P6 shipped without their rows being updated — see `git log --grep="Wallet P"`). P7 partial: the four descriptor RPCs (G7-42) and the Sparrow acceptance run remain.
